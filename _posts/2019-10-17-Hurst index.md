...
从表 1 可以看出，虽然沪深 300 指数 10 月份日价差波动范围不是大，从 6
0 到 1190 点；但最后交易日价差范围却处于-24 到 15 之间，最终价差都是逐步 走低到-5 点左右。从图 1 的频数分布图可见，55％的绝对价差都是在 40-65 点 之间。从此表分析中还不能得出明显的套利行为。
