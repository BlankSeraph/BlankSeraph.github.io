...
**My Blog Url: [http://blankseraph.github.io/](http://blankseraph.github.io/)**. If you like this theme, you can give me a star to encourage me. Welcome everyone to use it.
...
```yml
# other links
twitter_username: orange
facebook_username: yongqi.li
github_username:  blankseraph
email: lucidtime@qq.com
weibo_username: 3115521wh
zhihu_username: 五阿哥
linkedIn_username: 李勇奇
dribbble_username:

description_footer: 本站记录我的数据科学之旅```
